...
@click.option(
    ...
    envvar="SATS_TOKEN",
    default=None,
    help="[Required] The OATH GitHub API token to use " + "to connect.",
)
@click.option(
    "--command",
    "-c",
    "command",
    envvar="SATS_COMMAND",
    type=click.Choice([satsuki.Arguments.CMD_DELETE, satsuki.Arguments.CMD_UPSERT]),
...
@click.option(
    ...
    envvar="SATS_SLUG",
    default=None,
    help="[Required] Either repo and user or "
...
@click.option(
    ...
    envvar="SATS_REPO",
    default=None,
    help="[Required] Either the tag name OR the "
...
@click.option(
    ...
    "-r",
    "rel_name",
    envvar="SATS_REL_NAME",
    default=None,
    help="The name of the release. Default: tag name",
)
@click.option(
    "--latest",
    "latest",
...
@click.option(
    ...
    envvar="SATS_BODY",
    default=None,
    help="The message that shows up with releases. " + "Default: Release <tag>",
)
@click.option(
    "--pre",
    "-p",
    ...
    is_flag=True,
    default=None,
    help="[Flag] Whether or not this " + "release is a prerelease. Default: Not",
)
@click.option(
    "--draft",
    "-d",
    ...
    is_flag=True,
    default=None,
    help="[Flag] Whether or not this " + "release is a draft. Default: Not",
)
@click.option(
    "--force",
    "force",
...
@click.option(
    "--commitish",
    "commitish",
    envvar="SATS_COMMITISH",
    default=None,
    help="**[Required]** Can be any branch or commit "
    + "SHA. Unused "
...
@click.option(
    "--include-tag",
    "include_tag",
    envvar="SATS_INCLUDE_TAG",
    is_flag=True,
    default=False,
    help="Whether to delete the tag " + "when deleting the release.",
)
@click.option(
    "--file",
    "-f",
    ...
    multiple=True,
    default=None,
    help="File(s) to be uploaded as release asset(s). "
...
@click.option(
    ...
    multiple=True,
    default=None,
    help="Label to display for files instead of the "
...
@click.option(
    ...
    multiple=True,
    default=None,
    help="The mime type for files. Default: A guess "
...
@click.option(
    "--files-file",
    "files_file",
    envvar="SATS_FILES_FILE",
    default=None,
    help="File containing name(s) of files to be "
    + "uploaded."
